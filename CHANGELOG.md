...
### Fixed
- Settings SUBSCRIPTIONS tests: poll until probes leave `◌ checking…`
  instead of a fixed 60ms (macOS CI race across the whole tab).

## [1.2.2] — 2026-09-24

### Fixed
- Release CI flakes: wait for Settings disconnect auth re-probe; freeze
  Dashboard elapsed clock in null-meter comparison.
